...
public class EditarClienteJFrame extends javax.swing.JFrame {
     ...
     */
    public EditarClienteJFrame(int id_cliente) {
        initComponents();
    ...
    private void initComponents() {
        ...
        encabezado.setText("EDITAR CLIENTE");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        int nroDocumento = Integer.parseInt(this.txtNroDocumento.getText());
        ...
        if (nroDocumento != 0 && !apellido.trim().equals("") && !nombre.trim().equals("") && !direccion.trim().equals("") && !email.trim().equals("")) {
            if (nroDocumento > 4000000 && apellido.length() > 2 && nombre.length() > 2 && direccion.length() > 4 && esEmailValido(email)) {
                ...
                this.controlLogica.editarCliente(this.cliente, nroDocumento, apellido, nombre, direccion, email, telefono);
                mostrarMensaje("Edicion del registro del Cliente con exito", "Info", "Edicion Exitosa");
                ...
                this.mostrarMensaje("Los datos (Nro Documento, Apellido, Nombre, Direccion y/o Email) no son validos", "Error", "Campos invalidos");
            }
        } else {
            this.mostrarMensaje("Los campos Nro Documento, Apellido, Nombre, Direccion y Email son obligatorios, complete los campos", "Error", "Campos requeridos");
        }
    ...
    private void cargarCampos(int id_cliente) {
        this.cliente = controlLogica.traerCliente(id_cliente);

        this.txtNroDocumento.setText(String.valueOf(this.cliente.getNro_documento()));
        ...
        this.txtTelefono.setText(this.cliente.getTelofono());
    }
